...
var AppService = /** @class */ (function () {
    ...
    //add as friend
    AppService.prototype.addFriend = function (freindId, userId) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpParams"]()
            .set('request', freindId)
            .set('authToken', ng2_cookies_ng2_cookies__WEBPACK_IMPORTED_MODULE_2__["Cookie"].get('authtoken'));
        return this.http.put(this.url + "/api/v1/users/" + userId + "/addFriend", params);
    };
    //get all tasks
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        this.invitation = "http://virtuasha.online/sign-up?userId=" + this.userId;
    ...
    HomeComponent.prototype.addFriend = function (id, name) {
        var _this = this;
    ...
    HomeComponent.prototype.addToFriend = function (id, name) {
        ...
        this.appService.addFriend(id, this.userId).subscribe(function (apiResponse) {
            if (apiResponse.status === 200) {
                _this.snackBar.open("" + apiResponse.message, "Dismiss", {
                    duration: 5000,
                });
...
module.exports = __webpack_require__(/*! C:\Users\RITIK VERMA\Desktop\edwisor\frontend-master\src\main.ts */"./src/main.ts");
